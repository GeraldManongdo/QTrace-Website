...
$sql = "SELECT * FROM contractor_table WHERE Contractor_Id = ?";
...
// 3. Fetch Expertise
$sql_exp = "SELECT Expertise FROM contractor_expertise_table WHERE Contractor_Id = ?";
...
// 4. Fetch Documents
$sql_doc = "SELECT Document_Type, Document_Path FROM contractor_documents_table WHERE Contractor_Id = ?";
